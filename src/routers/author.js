...
const { authorValidationRules, validate } = require('../middlewares/authorValidator');
...
routers.post('/', authorValidationRules(), validate ,authorController.createAuthor);
routers.post('/:id',authorValidationRules(), validate ,authorController.updateAuthor);
