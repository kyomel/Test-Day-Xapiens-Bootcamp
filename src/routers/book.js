...
const { bookValidationRules, validateBook } = require('../middlewares/bookValidator');
...
routers.post('/', bookValidationRules(), validateBook, bookController.createBook);
routers.post('/:id', bookValidationRules(), validateBook, bookController.updateBook);
